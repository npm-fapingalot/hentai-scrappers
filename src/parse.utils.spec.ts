...
import { isUndefined, isDefined, isEmpty, isSomething, regexExtract, toInt, htmlTrim, rmChildren, getRootText, renameKeys } from './parse.utils';
...
describe('#re', () => {
  test('Working', () => {
    ...
    expect(renameKeys(obj, { meta: 'metadata', tag: 'tags' })).toStrictEqual({
      metadata: [1, 2, 3],
      tags: [4, 5, 6],
      extra: [7, 8, 9]
    });
